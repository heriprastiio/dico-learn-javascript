...
// TODO
const restaurant = {name: 'KFC', city: 'Jakarta', "favorite drink": 'Coke', "favorite food": 'Chicken', isVegan: false};
const name = restaurant.name;
const favoriteDrink = restaurant['favorite drink'] = "favorite drink";
